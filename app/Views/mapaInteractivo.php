...
<style>
    :root {
        --nelva-primary: #2c3e50;
        --nelva-secondary: #2e5aeb;
        --nelva-accent: #3498db;
        --nelva-light: #ecf0f1;
        --nelva-dark: #2c3e50;
        --nelva-text: #333;
    ...
    .nelva-parallax-hero {
        ...
        margin-left: -50vw;
        position: relative;
        background-image: url('<?= base_url('images/atractivos/mazunte1.png') ?>');
    ...
    .nelva-map-display {
        ...
        max-width: 800px; /* Hacemos el contenedor más estrecho */
        width: 90%;
    }
    ...
    .nelva-action-title {
        font-size: 1.8rem;
        color: var(--nelva-dark);
        margin-bottom: 15px;
    }

    .nelva-action-text {
        font-size: 1.1rem;
        color: var(--nelva-text-light);
        margin-bottom: 30px;
    }

    .nelva-primary-button {
        display: inline-block;
        background-color: var(--nelva-secondary);
        color: white;
        padding: 14px 35px;
        border-radius: 30px;
