<?= view('templates/navbar', ['title' => 'Coral - Nelva Bienes Raíces']) ?>
...
<style>
    ...
    .hero::before {
        ...
        width: 100%;
        height: 100%;
        background: url('<?= base_url('images/Coral/banner.jpg') ?>') center/cover no-repeat;
...
<!-- WhatsApp Floating Button -->
<a href="https://wa.me/5219581362522?text=Hola,%20me%20interesa%20saber%20más%20sobre%20Fraccionamiento%20Coral" class="whatsapp-float" target="_blank">
...
<section class="section">
    <div class="container">
        <h2 class="section-title">Descubre Fraccionamiento Coral</h2>
        <p class="text-center mb-30" style="max-width: 800px; margin-left: auto; margin-right: auto;">
            Fraccionamiento Coral ofrece terrenos totalmente planos con calles de 10 metros, certeza legal y áreas verdes, a solo minutos de las mejores playas de la región. Una inversión inteligente con posesión inmediata y fácil acceso a la Carretera Federal 200.
        </p>
...
<section class="section">
    <div class="container">
        <div class="amenities-container">
            <h3 class="amenities-title">Playas Cercanas</h3>
            ...
            <div class="amenities-list">
                <div class="amenity-item">
                    ...
                    <p>Playa Cangrejo (12 minutos)</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-umbrella-beach"></i>
                    </div>
                    <p>Playa Tablón (13 minutos)</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-umbrella-beach"></i>
                    </div>
                    <p>Dunas de Chipehua (15 minutos)</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-umbrella-beach"></i>
                    </div>
                    <p>Playa Bamba (20 minutos)</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-city"></i>
                    </div>
                    <p>Centro de Salina Cruz (30 minutos)</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section" style="background-color: #f8f9fa;">
    <div class="container">
        ...
        <div style="max-width: 480px; margin: auto; box-shadow: var(--shadow-lg); border-radius: 12px; overflow: hidden;">
            <img src="<?= base_url('images/Coral/plano.webp') ?>" alt="Plano de Fraccionamiento Coral" style="width: 100%; height: auto; display: block;">
        </div>
        <p class="text-center" style="margin-top: 20px; font-size: 1.1rem; color: var(--gray);">
            Diseño urbanístico con calles amplias de 10 metros y distribución estratégica cerca de la Carretera Federal 200.
        </p>
    </div>
</section>
    ...
    <div class="container">
        <div class="map-container2">
            <div class="map-content2">
                ...
                <p>Ubicado en Salina Cruz, Oaxaca, Fraccionamiento Coral está a solo 1 minuto de la Carretera Federal 200 y a pocos minutos de las playas más hermosas de la región, combinando accesibilidad con potencial de inversión en una zona de alto crecimiento turístico.</p>
                <a href="/asesores?zona=istmo" class="btn btn-secondary">Solicitar información</a>
            </div>
            <div class="map-iframe-container2">
                <iframe src="https://www.google.com/maps/embed?pb=!1m17!1m12!1m3!1d3104.7182915618555!2d-95.3894444!3d16.0925278!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zMTbCsDA1JzMzLjEiTiA5NcKwMjMnMjIuMCJX!5e1!3m2!1ses-419!2smx!4v1754967261845!5m2!1ses-419!2smx" class="map-iframe2" allowfullscreen="" loading="lazy"></iframe>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="gallery-container">
            <div class="gallery-item">
                <img src="<?= base_url('images/Coral/coral1.jpg') ?>" alt="Vista del Fraccionamiento">
                <div class="gallery-caption">Entrada principal</div>
            </div>
            <div class="gallery-item">
                <img src="<?= base_url('images/Coral/coral2.jpg') ?>" alt="Vista del Fraccionamiento">
                <div class="gallery-caption">Calles de 10 metros</div>
            </div>
            <div class="gallery-item">
                <img src="<?= base_url('images/Coral/banner.jpg') ?>" alt="Vista del Fraccionamiento">
                <div class="gallery-caption">Calles de 10 metros</div>
            </div>
...
<section class="contact-cta">
    <div class="container">
        <h2>¿Listo para invertir en Fraccionamiento Coral?</h2>
        <p>Contáctanos hoy mismo para recibir información detallada sobre esta excelente oportunidad de inversión cerca de las mejores playas de Oaxaca.</p>
        <a href="/asesores?zona=istmo" class="btn btn-secondary">Contactar Asesor</a>
    </div>
</section>
