...
<!-- WhatsApp Floating Button -->
<a href="https://wa.me/5219581362522?text=Hola,%20me%20interesa%20saber%20más%20sobre%20Fraccionamiento%20Real%20Campestre" class="whatsapp-float" target="_blank">
...
<section class="promo-section">
    <div class="promo-container">
        <div class="promo-badge float-animation">
        ...
        <div class="promo-highlight">
            <span class="promo-price">$120,000 <span>MXN</span></span>
        ...
        <a href="/asesores?zona=costa" class="btn btn-patriotic">¡Aprovecha esta oferta!</a>
        
        <p class="promo-note">* Promoción válida exclusivamente del 1 al 30 de septiembre de 2025.</p>
    </div>
</section>
...
<section class="section">
    <div class="container">
        <h2 class="section-title">Descubre Real Campestre</h2>
        <p class="text-center mb-30" style="max-width: 800px; margin-left: auto; margin-right: auto;">
            El Fraccionamiento Real Campestre es un desarrollo exclusivo ubicado en el corazón de la costa oaxaqueña, 
            diseñado para quienes buscan tranquilidad, seguridad y un estilo de vida en armonía con la naturaleza, 
            sin renunciar a la cercanía con los principales atractivos turísticos de la región.
        </p>
        ...
        <div class="amenities-container">
            ...
            <div class="amenities-list">
                ...
                <div class="amenity-item">
                    ...
                    <p>A 2 minutos de Ventanilla</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-ship"></i>
                    </div>
                    <p>A 30 minutos de Puerto Escondido</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-tree"></i>
                    </div>
                    <p>Zona de manglares protegidos</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-sun"></i>
                    </div>
                    <p>Clima cálido todo el año</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="section" style="background-color: #f8f9fa;">
    <div class="container">
        ...
        <div style="max-width: 480px; margin: auto; box-shadow: var(--shadow-lg); border-radius: 12px; overflow: hidden;">
            <img src="<?= base_url('images/RealCampestre/plano.webp') ?>" alt="Plano de Real Campestre" style="width: 100%; height: auto; display: block;">
        </div>
    ...
    <div class="container">
        ...
        <div class="gallery-container">
            ...
            <div class="gallery-item">
                <img src="<?= base_url('images/RealCampestre/real1.png') ?>" alt="Vista del Fraccionamiento">
                <div class="gallery-caption">Vista aérea del terreno</div>
            </div>
            <div class="gallery-item">
                <img src="<?= base_url('images/RealCampestre/real2.png') ?>" alt="Vista del Fraccionamiento">
                <div class="gallery-caption">Vista aérea del terreno</div>
            </div>
            <div class="gallery-item">
                <img src="<?= base_url('images/RealCampestre/real3.png') ?>" alt="Vista del Fraccionamiento">
                <div class="gallery-caption">Vista aérea del terreno</div>
            </div>
        </div>
    </div>
...
<script>
    // Countdown timer for September promotion
    function updateCountdown() {
        // Set the date we're counting down to (September 30, 2025)
        const countDownDate = new Date("Sep 30, 2025 23:59:59").getTime();
