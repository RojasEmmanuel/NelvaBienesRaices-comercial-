<?= view('templates/navbar', ['title' => 'Agua Marina - Nelva Bienes Raíces']) ?>
...
<!-- WhatsApp Floating Button -->
<a href="https://wa.me/5219581362522?text=Hola,%20me%20interesa%20saber%20más%20sobre%20Fraccionamiento%20Aguamarina" class="whatsapp-float" target="_blank">
...
<section class="section">
    <div class="container">
        <h2 class="section-title">Descubre Aguamarina</h2>
        <p class="text-center mb-30" style="max-width: 800px; margin-left: auto; margin-right: auto;">
            Vive en un entorno tranquilo, con acceso a servicios y rodeado de la belleza natural de Oaxaca. Aguamarina ofrece la combinación perfecta entre la comodidad urbana y la serenidad de la vida costera.
        </p>
        
        <div class="info-grid">
            <div class="info-card">
                <h3><i class="fas fa-file-signature"></i> Documentación</h3>
                <p>Escrituras en regla</p>
            </div>
            <div class="info-card">
    ...
    <div class="container features-container">
        ...
        <div class="features-grid">
            <div class="feature-item">
                ...
                <h3>Calles amplias</h3>
                <p>Para circulación cómoda</p>
            </div>
            <div class="feature-item">
                <div class="feature-icon">
        ...
        <div class="amenities-container">
            ...
            <div class="amenities-list">
                <div class="amenity-item">
                    ...
                    <p>A 80 m del CBTis local</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-route"></i>
                    </div>
                    <p>A 2 min de la Carretera Federal 200</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-building"></i>
                    </div>
                    <p>A 3 min de la cabecera municipal</p>
                </div>
                <div class="amenity-item">
                    <div class="amenity-icon">
                        <i class="fas fa-umbrella-beach"></i>
                    </div>
                    <p>A 15 min de hermosas playas</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="map-container2">
            <div class="map-content2">
                ...
                <p>Ubicado en Santa María Tonameca, Oaxaca, Aguamarina goza de una ubicación privilegiada cerca de servicios educativos, a minutos de la carretera principal y a solo 15 minutos de las hermosas playas de la región.</p>
...
<section class="contact-cta">
    <div class="container">
        <h2>¿Listo para ser parte de Fraccionamiento Aguamarina?</h2>
